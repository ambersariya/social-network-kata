...
class TestSocialNetwork:
    ...
    def test_post_message(self, message_repository):
        ...
        social_network.create_post(user=user, post=post)

        message_repository.add_post.assert_called_once_with(user=user, post=post)
    ...
    def test_get_timeline(self, message_repository):
        ...
        message_repository.get_timeline.assert_called_once_with(user=user)
